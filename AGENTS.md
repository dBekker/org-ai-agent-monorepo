...
3. `docs/ai/10-web-stack-nextjs-strapi-prisma.md`
4. `docs/ai/20-mobile-backend-fastapi-ai.md`
5. `docs/ai/01-figma-to-code.md  # when task touches UI`
6. `docs/ai/40-brownfield-adoption.md  # when task touches legacy code or migration`
7. `docs/ai/50-task-catalog.md`
...
`foundation-agent-standard` is configured as a multi-stack foundation.
